...
import RepairRequestDialog from '@/components/device/RepairRequestDialog';
...
export default function DeviceEditDialog({
  ...
  // สเตตัสสำหรับเปิดหน้าต่างแจ้งซ่อม
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mt-6 border-t pt-4">
          ...
          <div className="flex flex-wrap items-center gap-2 w-full sm:w-auto">
            ...
            <Button className="hover:bg-[#111827] hover:text-white" variant="outline" onClick={() => alert("เปิดฟอร์มเคลื่อนย้าย")}>
              เคลื่อนย้าย
            </Button>
            <Button className="hover:bg-[#111827] hover:text-white" variant="outline" onClick={() => alert("เปิดฟอร์มยืมอุปกรณ์")}>
              ยืมอุปกรณ์
            </Button>
            <Button className="hover:bg-[#111827] hover:text-white" variant="outline" onClick={() => alert("เปิดฟอร์มยืมอุปกรณ์")}>
              ทำความสะอาด
        ...
        {/* หน้าต่างย่อยสำหรับรับข้อมูลฟอร์มแจ้งซ่อม */}
        <RepairRequestDialog
          isOpen={isRepairOpen}
